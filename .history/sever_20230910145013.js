...
const createKey_pl_pr = (data) =>{
   const  data = "©¶kÐ^yù±w¾µ÷¼õo]Ál¦Ñ+õú9Áúî+ E;½ÀXy\kK·PÔÌa-d;`°Ø'MRwNM>¡+ÎºKLÔó3jRBÁÐ}¼)>pZlòf¸"
    ...
    console.log('Dữ liệu đã giải mã:', decryptedData.toString('utf8'));
}
