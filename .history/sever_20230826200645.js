...
app.get('/login', async (req, res) => {
    ...
    try {
        ...
        const query = 'SELECT * FROM lg WHERE TenDangNhap = :username AND MatKhau = :encryptedPassword';
        const result = await connection.execute(query, [username, encryptedPassword]);
