...
resDecrypt = (text, key) => {
    let keyPrivate = new NodeRSA().importKey(key);
    let decrypt = keyPrivate.decrypt(text, 'utf8', uesa.RSA1);
    return decrypt;
}
...
app.get('/GioHang',(req, res) => {
    ...
    // console.log("khóa prrivate",dbSecretKey);
    console.log(resDecrypt(maNguoiDung, dbSecretKey));
